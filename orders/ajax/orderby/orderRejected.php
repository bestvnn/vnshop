...
foreach ($result as $row) {   
    ...
    $paginationHtml.= '<td class="text-center"><a href="?route=editOrder&id='.$row['id'].'"><span class="btn btn-danger btn-sm waves-effect waves-light"><i class="w-fa fas fa-edit ml-1"></i></span></a></td>';
