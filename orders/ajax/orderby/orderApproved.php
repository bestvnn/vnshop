...
foreach ($result as $row) {   
    ...
    $paginationHtml.= '<td class="text-center"><a href="?route=editOrder&id='.$row['id'].'"><span class="btn btn-success btn-sm waves-effect waves-light"><i class="w-fa fas fa-edit ml-1"></i></span></a></td>';
    ...
    $paginationHtml.= '<td class="text-center"><b class="trigger green lighten-3">'._e($row['offer_name']).'</b></td>';



    $paginationHtml.= '<td class="text-center"><b class="text-success">x'._e($row['number']).'</b></td>';



    $paginationHtml.= '<td class="text-center"><b class="text-success">'.addDotNumber($row['price_sell']).'k</b></td>';
