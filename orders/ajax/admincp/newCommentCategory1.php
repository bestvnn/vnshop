...
if(!isAdmin())
    ...
    if($_db->exec_query("insert into `core_comment_categories1` set `category_id`='".escape_string($category_id)."',`category_name`='".escape_string($category_name)."' "))
    	exit('{"status":200,"message":"Thêm Comment Category 1 thành công!"}');
    else
