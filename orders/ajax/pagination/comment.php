...
$result = getData('core_comments','*',['status'=>$status],$sql,'id','desc',$perPage);

$paginationHtml = '';

foreach ($result as $row) {  
    $comment_category = getInfoById('core_offers','id,name',$row['comment_category_id']);            
    $comment_category1 = getInfoById('core_comment_categories1','id,category_name',$row['comment_category_id1']);                
    $comment_category2 = getInfoById('core_comment_categories2','id,category_name2',$row['comment_category_id2']);                
    $comment_landing = getInfoById('core_comment_landings','id,landing',$row['comment_landing_id']);
