...
<section class="row">
    <div class="col-md-6">
        <h2 class="section-heading mb-4"><span class="badge <?= getBgOrder($_status); ?>">Approved</span> Đơn hàng giao thành công (<?= $_count; ?>)</h2>
    </div>
    ...
    <div class="col-md-12 mx-auto white z-depth-1">
        <div class="mb-5">
            <form name="filter" method="GET">
                ...
                <input name="type" value="approved" type="hidden">
                    ...
                    <tbody id="content">
                        ...
                        if ($_data) {
                            ...
                            foreach ($_data as $arr) {
                                ...
                                echo '<td class="text-center"><a href="?route=editOrder&id=' . $arr['id'] . '"><span class="btn btn-success btn-sm waves-effect waves-light"><i class="w-fa fas fa-edit ml-1"></i></span></a></td>';
                                echo '<td class="text-center">Đơn hàng #<b>' . $arr['id'] . '</b></td>';
                                echo '<td class="text-center"><b class="trigger green lighten-3">' . $_offer_name . '</b></td>';
                                echo '<td class="text-center"><b class="text-success">x' . _e($arr['number']) . '</b></td>';
                                echo '<td class="text-center"><b class="text-success">' . addDotNumber($arr['price_sell']) . 'k</b></td>';
    ...
    $(document).ready(function() {
        $("#pageSize").on('change', function() {
            ...
            $.ajax({
                ...
                url: '<?= $_url; ?>/ajax.php?act=pagination-orderApproved&ts=<?php echo $ts; ?>&te=<?php echo $te; ?>&offer=<?php echo $offer; ?>&view=<?php echo $view; ?>',
        ...
        loadOrderBy('<?= $_url; ?>/ajax.php?act=orderby-orderApproved&ts=<?php echo $ts; ?>&te=<?php echo $te; ?>&offer=<?php echo $offer; ?>&view=<?php echo $view; ?>');
    });
</script>
<script type="text/javascript">
