...
if(isset($_GET['action'])){}else{
    if(isset($_GET['id']) && filter_var($_GET['id'],FILTER_VALIDATE_INT,array('min_range'=>1))){
        $comment_category2_id = $_GET['id'];
        $comment_category2 = getInfoId($comment_category2_id,'core_comment_categories2');
    }else{
...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $query = $_db->exec_query("update `core_comment_categories2` set `category_id`='".$category_id."',`category_id1`='".$category_id1."',`category_name2`='".$category_name."' where id='".$comment_category2['id']."' ");
    if($query==TRUE){         
        ...
        <form id="formUpdate" method="POST" onsubmit="return submitUpdate();" enctype="multipart/form-data">
            ...
            <div class="px-2">                
                <div class="form-group">
                    ...
                    <select id="category_id" name="category_id" class="form-control select-item" >
                        ...
                        <?php 
                            ...
                            {
                                if(isset($_GET['id'])){
                                    if($arr['id']==$comment_category2['category_id']){
                                        ?>
                ...
                <div class="form-group">
                    ...
                    <select id="category_id1" name="category_id1" class="form-control select-item">
                        ...
                        <?php 
                            ...
                            {
                                if(isset($_GET['id'])){
                                    if($arr1['id']==$comment_category2['category_id1']){
                                        ?>
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" class="form-control" name="category_name" id="category_name" value="<?php if(isset($_GET['id'])){ echo $comment_category2['category_name2'];} ?>">                    
                </div>               
            </div>
            <div class="form-group text-right">
                <span class="waves-input-wrapper waves-effect waves-light">
                    <a type="button" class="btn btn-danger" href="?route=commentCategoryTwo">Quay lại</a>
