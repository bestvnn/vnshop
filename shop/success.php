...
foreach ($_url_params as $key => $value) {
    if (base64_decode($key) == 'success') {
        ...
        $_order['order_address'] = $_order_decode[3];
...
if ($_has_order && $_POST) {
	...
	isset($_POST['order_phone']) && $_POST['order_phone']!='' && 
        isset($_POST['order_address']) && $_POST['order_address']!='') {
...
<head>
	...
	<script>
		...
		fbq('track', 'PageView');
		fbq('track', 'Purchase', {
			content_name: 'LuckyHorus', // Thay tên sản phẩm tại đây (không dấu, gạch dưới)
			content_type: 'product',
			value: 290000, 
			currency: 'VND'
		});
	</script>
	<noscript><img height="1" width="1" style="display:none"src="https://www.facebook.com/tr?id=1233398425416445&ev=Purchase&cd[value]=290000&cd[currency]=VND" /></noscript>
	<!-- End Meta Pixel Code -->
	<!-- Adskeeper Sensor -->
    ...
    <script src="js/districts.min.js" defer></script>
                ...
                <div class="success-page__header">
                    <div class="success-page__header-wrapper">
                        ...
                        <p class="success-page__message_success">
                            <br>
                            <a class="" href="home.php?<?= $_SERVER['QUERY_STRING'] ?>">Đặt đơn hàng mới</a>
                        </p>
                    </div>
                </div>
                    ...
                    <div class="success-page__body-wrapper">
                        ...
                        <div class="list-info">
                            <ul class="list-info__list">
                                ...
                                <li class="list-info__item">
                                    <span class="list-info__text">Địa chỉ: </span>
                                    <?= $_order['order_address'] ?>
                                </li>
                            </ul>
                        </div>
