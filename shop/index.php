...
if ($_POST) {
    if (isset($_POST['order_name']) && $_POST['order_name']!='' && 
		isset($_POST['order_phone']) && $_POST['order_name']!='' && 
        isset($_POST['order_address']) && $_POST['order_phone']!='') {
        ...
        $directUrl = 'error.php';
        if ($request['success']) {
			$request['order']['order_address'] = $_POST['order_address']; 
            ...
            if (!preg_match("#phone\: " . $_REQUEST['order_phone'] . " \|#si", $txt_order) && $_REQUEST['order_phone']) {
                @file_put_contents(dirname(__FILE__) . '/orders/' . date('d-m-Y', time()) . '.txt', "name: " . $_REQUEST['order_name'] . " | phone: " . $_REQUEST['order_phone'] . "order_address: " . $_POST['order_address'] . " | ads_name:" . $ads_name . "\n", FILE_APPEND);
            }
        } else if ($request['error']) {
            $_url_params['order_name'] = $_POST['order_name'];
            $_url_params['order_phone'] = $_POST['order_phone'];
            $_url_params['order_address'] = $_POST['order_address'];
...
<head>
    ...
    <title>Lucky Horus - Bùa hộ mệnh từ Ai Cập</title>
    <link rel="icon" href="img/prod.png" type="image/png">
    <link rel="shortcut icon" href="img/prod.png" type="image/png">
    <meta property="og:url" content="index.php" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Phương pháp đơn giản để thay đổi vận mệnh" />
    <meta property="og:image" content="img/prod.png" />
    <meta property="og:image:width" content="150" />
    <meta property="og:image:height" content="150" />
    <meta property="og:site_name" content="Lucky Horus - Bùa hộ mệnh từ Ai Cập" />
    <meta property="og:description" content="Lucky Horus - Bùa hộ mệnh từ Ai Cập" />
    <meta name="keywords" content="Lucky Horus, Amulet, bùa Lucky Horus, bùa thần tài, bùa làm giàu, bùa Horus chính hãng, bùa may mắn, bùa tình yêu, bùa hộ mệnh Ai Cập, bùa Horus Ai Cập, bùa trừ tà, eyes of horus, the eye of horus, xem bói vận mệnh, giải hạn cầu may, bùa tài lộc, bùa phong thủy" />
    <meta name="description" content="Lucky Horus giúp thu hút tiền bạc và sự may mắn cho chủ nhân. Mang theo Lucky Horus bạn sẽ có cuộc sống hạnh phúc và giàu có bền vững." />
    <link type="text/css" rel="stylesheet" href="css/main.css" />
    <script src="js/jquery-1.12.4.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="js/script.js"></script>
    <script type="text/javascript" src="js/dr-dtime.min.js"></script>
	<script src="js/jquery.connect.min.js" type="text/javascript"></script>
	<!-- Meta Pixel Code -->
	<script>
		...
		fbq('init', '1233398425416445');
		fbq('track', 'PageView');
		fbq('track', 'ViewContent');
	</script>
	<noscript><img height="1" width="1" style="display:none"src="https://www.facebook.com/tr?id=1233398425416445&ev=ViewContent&noscript=1"/></noscript>
	<!-- End Meta Pixel Code -->
	<!-- Adskeeper Sensor -->
	<script type="text/javascript">
		(function() {
			...
			w.MgSensorData.push({
				cid:771550,
				project: "a.adskeeper.com"
			});
			var l = "a.adskeeper.com";
...
<body>
    <div class="wrapper">
                ...
                <div class="flex-aic">
                    ...
                    <nav id="nav-js" class="flex nav">
                        <ul id="menu-js" class="flex menu list">
                            <li><a href="#what-is">Về Lucky Horus</a></li>
        ...
        <section id="main" class="flex-aic main">
            <img src="img/main-img1.jpg" alt="" class="main-img">
            <img src="img/main-img-mob1.jpg" alt="" class="main-img-mob">
            <div class="container">
                <div class="main-wrap">
                    <div class="subtitle">Các tế sư Ai Cập nói điều này về bùa hộ mệnh <br> Lucky Horus:</div>
                    <h1 class="h1 title">"Ngôi sao của sự giàu có<br> luôn tỏa sáng quanh bạn..."</h1>
                    <div class="main-descr">Lucky Horus được chứng minh là một trong những <span class="yellow-txt">bùa hộ mệnh mạnh nhất</span> mọi thời đại trên khắp thế giới. Người mang theo bùa hộ mệnh Lucky Horus không những giàu có nhanh chóng mà còn giữ được sự giàu có bền vững và luôn gặp nhiều may mắn, thành công trong cuộc sống.
                    </div>
        ...
        <section id="what-is" class="what-is">
            <img src="img/what-is.png" alt="" class="what-is-bg">
            <div class="container">
                <h2 class="h2">Lucky Horus và huyền thoại về vị thần cai quản bầu trời</h2>
                <div class="what-is-descr">
                    <p>Lucky Horus là bùa hộ mệnh xuất hiện từ thời Ai Cập cổ đại hơn 5000 năm trước. Bùa hộ mệnh này gắn liền với vị thần cai quản bầu trời hùng mạnh nhất trong thần thoại Ai Cập - thần Horus. Truyền thuyết kể lại rằng, vùng sa mạc bao quanh Ai Cập thấm đẫm máu của thần Horus khi con mắt của Người bị hủy hoại trong cuộc chiến với thần Seth tàn bạo trước khi được phục hồi kì diệu bởi thần Hathor.
                    </p>
                    <p>
                    ...
                    <p>
                        <span class="yellow-txt">Bùa hộ mệnh Lucky Horus được làm từ sắt trong sa mạc</span> nơi dòng máu của thần Horus đã đổ xuống - loại sắt này quý hiếm như vàng - là linh nghiệm nhất và được lan truyền qua nhiều thế hệ.
                    </p>
                    <p>Lucky Horus hoạt động với đặc trưng của mỗi cá nhân. Có nghĩa là bùa hộ mệnh sẽ kết hợp với dòng của riêng bạn và kích thích những năng lượng tích cực đồng thời bảo vệ bạn khỏi những năng lượng xấu. </p>
                    <img src="img/what-is.jpg" alt="" class="rsp-img what-is-img">
        ...
        <section id="celebrities" class="celebrities">
            <div class="container">
                <h2 class="h2">Người nổi tiếng có mang theo bùa hộ mệnh Lucky Horus?</h2>
                <div class="subtitle">Ngày nay Lucky Horus đã trở nên phổ biến trên toàn thế giới. Nhiều người nổi tiếng và giàu có tin rằng chính bùa hộ mệnh đã giúp họ đạt được rất nhiều.
                </div>
                <ul class="flex celebrities-list list">
                    <li class="item item-1">
                        <picture><img src="img/fm1.jpg" alt="" class="rsp-img item-photo"></picture>
                        <div class="flex item-wrap">
                            <div class="item-info">
                                <div class="item-post">Doanh nhân thành đạt tại phố Wall - Hoa Kì</div>
                                <div class="item-name">Minh Anh</div>
                            </div>
                            <div class="item-descr">Ở tuổi 34 và sở hữu khối tài sản kếch sù lên tới hơn 30 triệu đô la, Minh Anh cho rằng Lucky Horus có sức mạnh thu hút tiền bạc thật kì diệu. </div>
                        </div>
                    </li>
                    <li class="item item-3">
                        <picture><img src="img/fm2.jpg" alt="" class="rsp-img item-photo"></picture>
                        <div class="flex item-wrap">
                            <div class="item-info">
                                <div class="item-post">Người mẫu, dẫn chương trình, ca sĩ hải ngoại nổi tiếng.</div>
                                <div class="item-name">Hoàng Quốc Đạt </div>
                            </div>
                            <div class="item-descr">Trẻ trung, năng động và thành công nhưng Quốc Đạt luôn mang theo bên mình bùa hộ mệnh Lucky Horus. Những vũ điệu sôi động trên sân khấu và chiếc bùa hộ mệnh sáng lấp lánh của anh tạo nên một phong cách hoàn toàn mới mẻ và hấp dẫn.
                            </div>
                        </div>
                    </li>
                    <li class="item item-2">
                        <picture><img src="img/fm3.jpg" alt="" class="rsp-img item-photo"></picture>
                        <div class="flex item-wrap">
                            <div class="item-info">
        ...
        <section id="reviews" class="reviews">
            <div class="container">
                ...
                <ul id="reviews-carousel" class="flex reviews-list list">
                    <li class="item">
                        <div class="item-wrap">
                            <picture class="item-review"><img src="img/review/1.jpg" alt="" class="rsp-img"></picture>
                        </div>
                    </li>
                    <li class="item">
                        <div class="item-wrap">
                            <picture class="item-review"><img src="img/review/3.jpg" alt="" class="rsp-img"></picture>
                        </div>
                    </li>
                    <li class="item">
                        <div class="item-wrap">
                            <picture class="item-review"><img src="img/review/2.jpg" alt="" class="rsp-img"></picture>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <section id="get-bead" class="get-bead">
            <div class="container">
                <div class="get-bead-wrap">
                    ...
                    <span class="old_price">Giá thường: <span class="price_land_curr">1,380,000<sup> đ</sup></span></span>
                    ...
                    <div class="subtitle">Giảm giá 50% đến hết ngày <script>
                            dtime_nums(-1, true)
                        </script>
                    </div>
                    <form action="index.php?<?= $_SERVER['QUERY_STRING'] ?>" method="POST" class="get-bead-form order_form orderformcdn">
                        ...
                        <input type="text" name="order_name" required="" placeholder="Họ và tên">
                        <input type="tel" name="order_phone" required="" placeholder="Số điện thoại">
                        <input type="text" name="order_address" required="" placeholder="Địa chỉ nhận hàng">
        ...
        <footer class="footer">
            <div class="container">
                <div class="social">
                    <div class="copyright">
                        <img src="img/rekv_ALL.png" style="display:block;margin:0 auto">
                        © 2026 Lucky Horus. All rights reserved
                        <br>
                        |
